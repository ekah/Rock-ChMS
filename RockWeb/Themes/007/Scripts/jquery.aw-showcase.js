/*
	...
	Version: 1.0 patched by Nick Airdo as described by "Samuel":
	http://www.awkwardgroup.com/sandbox/awkward-showcase-a-jquery-plugin/#comment-362926921
		...
		function slideThumbnailWrapper(direction, check, backwardforward)
		{
			...
			if (check)
			{
				...
				if ((current_id - lastVisible) > options.thumbnails_slidex)
				{
					...
					console.log ( 'current_id : ' + current_id + ' lastVisible: ' + lastVisible );
					...
					while (distance > options.thumbnails_slidex)
					{
						...
						if ( xxxi < 10 )
						{
							console.log ( 'distance : ' + distance + ' options.thumbnails_slidex: ' + options.thumbnails_slidex + "multiplySlidePosition: " + multiplySlidePosition);
						}
						distance = distance - options.thumbnails_slidex;
