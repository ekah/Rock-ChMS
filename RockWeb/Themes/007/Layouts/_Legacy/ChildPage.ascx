...
*
* $Workfile: ChildPage.ascx $
* $Revision: 9 $ 
* $Header: /trunk/Arena/Templates/Cccev/007/ChildPage.ascx   9   2012-11-14 09:56:14-07:00   JasonO $
**********************************************************************/
%>
			...
			<div id="main-inner">
			 	<div id="content">
					<div class="post hentry">
					  ...
					  <div class="entry-content colA"> <asp:PlaceHolder ID="phBottomLeft" runat="server" />  </div>
					  <div class="entry-content colB"> <asp:PlaceHolder ID="phBottomRight" runat="server" />  </div>
					</div><!-- end post-->
				</div><!-- end #content -->
				<div id="side-right">
